...
function Call-MainForm_pff
{
	...
	$tabpage_DEseries = New-Object 'System.Windows.Forms.TabPage'
	...
	$ApplicationLastUpdate	= "2019/10/14"
	
	# Author Information
	$AuthorName			= "rapha-ripoff"
	$AuthorEmail 		= "raphael.santos@gardastaff.ie"
	$AuthorBlogName 	= ""
	$AuthorBlogURL 		= ""
	$AuthorTwitter 		= ""
	$AuthorTwitterURL	= ""
	...
	$button_DiskUsage_Click={
		...
		Add-Logs -text " - Hard Drive - DiskSpace"
		$result = Invoke-Command -ComputerName PRDC-PLV-NBT121 -ScriptBlock {powershell.exe /c echo y | D:\Putty\pscp.exe -ls -i D:\Putty\FCBTCH02_PRIV_LIVE.ppk FCBTCH02@10.128.0.192:/PAYMENTS/FirearmPaymentsReceived/RESPONSE/} | Out-String
		Add-RichTextBox -text $result
	}
		
	$button_FIRPAYREC_Click={
		Get-ComputerTxtBox
    ...
    $oldLocation = "C:\Program Files (x86)\Microsoft Configuration Manager\AdminConsole\bin\i386\CmRcViewer.exe"
    if (Test-Path $oldLocation) {
        # Run the application from the old location
        start-process $oldLocation $computername
    }
    else {
        $newLocation = "C:\Program Files (x86)\Microsoft Endpoint Manager\AdminConsole\bin\i386\CmRcViewer.exe"
        if (Test-Path $newLocation) {
            # Run the application from the new location
            start-process $newLocation $computername
        }
        else {
            [System.Windows.Forms.MessageBox]::Show("Error: CmRcViewer.exe not found in either location.")
        }
    }
}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$button_FIRPAYREC.remove_Click($button_FIRPAYREC_Click)
...
cMI4bmTc512jvQLAriAIyPd9Y6mAG6gAZUPR6LYBAAAAAElFTkSuQmCC')
	...
	$tabcontrol_computer.Controls.Add($tabpage_DEseries)
...
5LXck2d3nPn/B4ulijzV+jwQAAAAAElFTkSuQmCC')
	...
	#
	#region Binary Data
	$buttonRemoteAssistance.Image = [System.Convert]::FromBase64String('')
	#endregion
	...
	$buttonRemoteAssistance.Text = "Remote Control Viewer"
...
yOl5co93qgAAAABJRU5ErkJggg==')
	...
	# tabpage_FIRPAYREC
	#
	$tabpage_DEseries.Controls.Add($button_FIRPAYREC)
	$tabpage_DEseries.Location = '4, 22'
	$tabpage_DEseries.Name = "tabpage_DeSeries"
	$tabpage_DEseries.Size = '1162, 111'
	$tabpage_DEseries.TabIndex = 10
	$tabpage_DEseries.Text = "DeSeriesfilecheck"
	$tabpage_DEseries.UseVisualStyleBackColor = $True
	#
	# button_FIRPAYREC
	#
	$button_FIRPAYREC.Location = '8, 3'
	$button_FIRPAYREC.Name = "FIRPAYREC"
	$button_FIRPAYREC.Size = '112, 23'
	$button_FIRPAYREC.TabIndex = 22
	$button_FIRPAYREC.Text = "FIRPAYREC"
	$button_FIRPAYREC.UseVisualStyleBackColor = $True
	$button_FIRPAYREC.add_Click($button_FIRPAYREC_Click)
